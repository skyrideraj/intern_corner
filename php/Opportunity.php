...
class Opportunity
{
	...
	function __construct($username,$opportunity_id, $opportunity_type, $title, $description, $deadline, $start_date, $end_date, $stipend, $organization, $location, $tags, $timestamp)
	{
		# code...
	...
	function addOpportunity(){
		...
		if($allowed_to_post==1){
			if($this->oppurtunity_type==1){
			$db->query("INSERT INTO opportunity (opportunity_id,opportunity_type,timestamp) VALUES(NULL,$this->opportunity_type,NULL)");
...
// print_r($rr);
echo 'hi';
$opp=new Opportunity('skyrider',NULL,1,'title','desc',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);
